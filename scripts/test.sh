...
# python scripts/test.py --topologies "grid__dim=(2,3)" "grid__dim=(2,4)" "grid__dim=(2,5)" "grid__dim=(3,3)" "grid__dim=(3,4)" "grid__dim=(3,5)" "grid__dim=(4,4)" "grid__dim=(4,5)"
# Homogeneous torus experiment
# python scripts/test.py --topologies "torus__dim=(2,3)" "torus__dim=(2,4)" "torus__dim=(2,5)" "torus__dim=(3,3)" "torus__dim=(3,4)" "torus__dim=(3,5)" "torus__dim=(4,4)" "torus__dim=(4,5)"
...
# python scripts/test.py --topologies "grid__dim=(3,3)" --synthesizers "beam_chunk" "beam_shortest" --temperature 0.1 0.25 0.5 0.75 1 2 5 10
# Num Beams experiment
# python scripts/test.py --topologies "grid__dim=(3,3)" --synthesizers "beam_chunk" "beam_shortest" --num_beams 5 10 30 60 120 240